...
public class PaymentsController : ControllerBase
{
    ...
    public PaymentsController(IUnitOfWork unitOfWork, IMoMoPaymentService momoPaymentService, IVNPayService vnPayService, IPayOSPaymentService payOSPaymentService, ITierConfigService tierConfigService)
    {
